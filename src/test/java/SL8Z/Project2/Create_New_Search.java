...
public class Create_New_Search {
    ...
    @Test
	  ...
	  // Position Title
	  driver.findElement(By.xpath("//input[@id='title']")).sendKeys("Test Automated Post 2");
